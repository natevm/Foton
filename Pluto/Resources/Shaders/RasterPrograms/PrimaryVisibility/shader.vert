...
layout(location = 5) out precise vec2 s_motion;
...
void main() {
    ...
    precise vec4 v_p_curr = gl_Position = viewproj * cam_worldToLocal * vec4(w_position, 1.0);
    precise vec4 v_p_prev = viewproj * cam_worldToLocalPrev * target_localToWorldPrev * vec4(m_position, 1.0);
